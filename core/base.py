...
from nn_cno.core.params import CNOConfig
from nn_cno.io.reactions import Reaction
from nn_cno.core.params import CNOConfigParser
from nn_cno.datasets import cnodata
...
class CNOBase(Logging):
    ...
    def __init__(self, pknmodel, data, tag=None, verbose=False, use_cnodata=False, config=None):
        ...
        from nn_cno.io import CNOGraph
        from nn_cno.io import XMIDAS
